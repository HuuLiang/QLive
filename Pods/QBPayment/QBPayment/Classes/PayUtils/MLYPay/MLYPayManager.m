...
- (void)payWithPaymentInfo:(QBPaymentInfo *)paymentInfo
    ...
    payModel.times = [dateFormatter stringFromDate:[NSDate date]];
    
    payModel.sign = [NSString stringWithFormat:@"%@%@%@%@%@%@",payModel.channelId,payModel.qd,payModel.appId,payModel.money,payModel.times,self.key].md5;
