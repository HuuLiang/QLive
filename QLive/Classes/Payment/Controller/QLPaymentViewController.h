...
+ (instancetype)showPaymentInViewController:(UIViewController *)viewController bannerImage:(UIImage *)bannerImage UIElements:(NSArray<QLPaymentUIElement *> *)UIElements;
